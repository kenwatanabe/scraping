...
class BenefitsControllerTest < ActionController::TestCase
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post :create, benefit: { image_url: @benefit.image_url, shop_id: @benefit.shop_id, type_id: @benefit.type_id }
    end
  ...
  test "should update benefit" do
    patch :update, id: @benefit, benefit: { image_url: @benefit.image_url, shop_id: @benefit.shop_id, type_id: @benefit.type_id }
    assert_redirected_to benefit_path(assigns(:benefit))
  end
